...
{
public:
char lawyername[100],auname[50],sc[20],sc1[50];
int q,B,p,phn;
Lib()
{
strcpy(lawyername,"NO Lawyer Name");
strcpy(auname,"No Client Name");
...
cout<<"\n\t\tEnter the details :-\n";
cout<<"\n\t\tEnter Lawyer's Name : ";
cin.getline(lawyername,100);
for(i=0;lawyername[i]!='\0';i++)
{
if(lawyername[i]>='a'&&lawyername[i]<='z')
lawyername[i]-=32;
}
...
void Lib::show(int i)
{
cout<<"\n\t\tLawyer's' Name : "<<lawyername<<endl;
cout<<"\n\t\tSpecilization : "<<auname<<endl;
cout<<"\n\t\tLawyer's License' : "<<sc<<endl;
cout<<"\n\t\tPhone no : "<<phn<<endl;
if(i==2)
{
cout<<"\n\t\tCost per date : "<<p<<endl;
cout<<"\n\t\tcases won : "<<q<<endl;
}
}
...
while(!intf.eof())
{
for(i=0;b==B&&lawyername[i]!='\0'&&st1[i]!='\0'&&(st1[i]==lawyername[i]||st1[i]==lawyername[i]+32);i++);
if(lawyername[i]=='\0'&&st1[i]=='\0')
{
cont++;
getdata();
...
int Lib::specilization(int x)
{
int i;
cout<<"\n\t\t>>Please Choose one Specilization :-\n";
cout<<"\n\t\t1.Civil Law\n\n\t\t2.Tax Law\n\n\t\t3.Criminal Law\n\n\t\t4.Corporate Law\n\n\t\t5.Labour Law\n\n\t\t6.Real Estate law\n\n\t\t7.Go to menu\n";
cout<<"\n\t\tEnter youur choice : ";
cin>>i;
switch(i)
...
while(!intf.eof())
{
for(i=0;b==B&&q!=0&&lawyername[i]!='\0'&&ch[i]!='\0'&&(ch[i]==lawyername[i]||ch[i]==lawyername[i]+32);i++);
if(lawyername[i]=='\0'&&ch[i]=='\0')
{
cout<<"\n\t\tBook Found :-\n";
show(x);
cont++;
...
system("cls");
cout<<"\n\t\t->Please Choose one option :-\n";
cout<<"\n\t\t1.Hire Lawyer\n\n\t\t2.View Hired Lawyer\n\n\t\t3.Search person who hired lawyers\n\n\t\t4.Rehire lawyer\n\n\t\t5.Dismiss Lawyer\n\n\t\t6.Go back to menu\n\n\t\tEnter Your Choice : ";
cin>>i;
fflush(stdin);
if(i==1)
{
...
cout<<"\n\t\tEnter Client's Problem : ";
cin.getline(sc1,20);
cout<<"\n\t\tEnter date : ";
cin>>q>>B>>p;
ofstream outf("client.txt",ios::binary|ios::app);
outf.write((char*)this,sizeof(*this));
outf.close();
cout<<"\n\n\t\tHiring Successfull.\n";
}
...
{
ifstream intf("client.txt",ios::binary);
system("cls");
cout<<"\n\t\t->The Details are :-\n";
intf.read((char*)this,sizeof(*this));
i=0;
...
cout<<"\n\t\tEnter Client's problem : ";
cin.getline(st1,20);
fstream intf("client.txt",ios::in|ios::out|ios::ate|ios::binary);
intf.seekg(0);
intf.read((char*)this,sizeof(*this));
while(!intf.eof())
{
...
{
int i;
cout<<"\n\t************ Welcome To Lawyerup ************\n Hire City's best Lawyers according to your need \n Civil Law ,Criminal Law,Realestate Law,Corporate law & many more\n";
